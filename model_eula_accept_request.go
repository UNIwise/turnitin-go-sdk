...
// EulaAcceptRequest struct for EulaAcceptRequest
...
func (o EulaAcceptRequest) MarshalJSON() ([]byte, error) {
...
type NullableEulaAcceptRequest struct {
	value *EulaAcceptRequest
	isSet bool
}

func (v NullableEulaAcceptRequest) Get() *EulaAcceptRequest {
	return v.value
}

func (v *NullableEulaAcceptRequest) Set(val *EulaAcceptRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEulaAcceptRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEulaAcceptRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEulaAcceptRequest(val *EulaAcceptRequest) *NullableEulaAcceptRequest {
	return &NullableEulaAcceptRequest{value: val, isSet: true}
}

func (v NullableEulaAcceptRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEulaAcceptRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
