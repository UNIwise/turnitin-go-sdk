...
// SubmissionAllOf struct for SubmissionAllOf
type SubmissionAllOf struct {
...
func (o SubmissionAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSubmissionAllOf struct {
	value *SubmissionAllOf
	isSet bool
}

func (v NullableSubmissionAllOf) Get() *SubmissionAllOf {
	return v.value
}

func (v *NullableSubmissionAllOf) Set(val *SubmissionAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSubmissionAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSubmissionAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubmissionAllOf(val *SubmissionAllOf) *NullableSubmissionAllOf {
	return &NullableSubmissionAllOf{value: val, isSet: true}
}

func (v NullableSubmissionAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubmissionAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
