...
// SubmissionCompleteWebhookRequestAllOf struct for SubmissionCompleteWebhookRequestAllOf
type SubmissionCompleteWebhookRequestAllOf struct {
...
func NewSubmissionCompleteWebhookRequestAllOf() *SubmissionCompleteWebhookRequestAllOf {
	this := SubmissionCompleteWebhookRequestAllOf{}
	return &this
}
...
func (o SubmissionCompleteWebhookRequestAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSubmissionCompleteWebhookRequestAllOf struct {
	value *SubmissionCompleteWebhookRequestAllOf
	isSet bool
}

func (v NullableSubmissionCompleteWebhookRequestAllOf) Get() *SubmissionCompleteWebhookRequestAllOf {
	return v.value
}

func (v *NullableSubmissionCompleteWebhookRequestAllOf) Set(val *SubmissionCompleteWebhookRequestAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSubmissionCompleteWebhookRequestAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSubmissionCompleteWebhookRequestAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubmissionCompleteWebhookRequestAllOf(val *SubmissionCompleteWebhookRequestAllOf) *NullableSubmissionCompleteWebhookRequestAllOf {
	return &NullableSubmissionCompleteWebhookRequestAllOf{value: val, isSet: true}
}

func (v NullableSubmissionCompleteWebhookRequestAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubmissionCompleteWebhookRequestAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
