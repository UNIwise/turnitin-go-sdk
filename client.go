...
// APIClient manages communication with the Turnitin Core API API v1.0.249
...
type APIClient struct {
	...
	SimilarityApi *SimilarityApiService

	SubmissionApi *SubmissionApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SimilarityApi = (*SimilarityApiService)(&c.common)
	c.SubmissionApi = (*SubmissionApiService)(&c.common)
